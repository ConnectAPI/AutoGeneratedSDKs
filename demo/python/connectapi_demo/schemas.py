...
class TestIn:
    def __init__(self, a: int, b: str, c: bool, d: None, e: object, f: List, g, a_o: int = None, b_o: str = None, c_o: bool = None, d_o: None = None, e_o: object = None, f_o: List = None, g_o=None, ):
        self.a = a
        self.a_o = a_o
        self.b = b
        self.b_o = b_o
