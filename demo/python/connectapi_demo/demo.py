...
class Demo:
    ...
    def sum_two_numbers(self, a: int, b: int, ):
        ...
        cookies = {}
        body = {}
        response = self.client.request('get', self.service_prefix, path, query, headers, cookies, body=body )
    ...
    def post_test(self, ):
        ...
        cookies = {}
        body = {}
        response = self.client.request('post', self.service_prefix, path, query, headers, cookies, body=body )
        if response.status_code == 200:
            """Successful Response"""
            if response.headers.get("Content-Type", None) == "application/json":
                return response.json()
    ...
    def put_test(self, ):
        ...
        cookies = {}
        body = {}
        response = self.client.request('put', self.service_prefix, path, query, headers, cookies, body=body )
        if response.status_code == 200:
            """Successful Response"""
            if response.headers.get("Content-Type", None) == "application/json":
                return response.json()
    ...
    def delete_test_test(self, ):
        ...
        cookies = {}
        body = {}
        response = self.client.request('delete', self.service_prefix, path, query, headers, cookies, body=body )
        if response.status_code == 200:
            """Successful Response"""
            if response.headers.get("Content-Type", None) == "application/json":
                return response.json()
    ...
    def options_test(self, ):
        ...
        cookies = {}
        body = {}
        response = self.client.request('options', self.service_prefix, path, query, headers, cookies, body=body )
        if response.status_code == 200:
            """Successful Response"""
            if response.headers.get("Content-Type", None) == "application/json":
                return response.json()
    ...
    def head_test(self, ):
        ...
        cookies = {}
        body = {}
        response = self.client.request('head', self.service_prefix, path, query, headers, cookies, body=body )
        if response.status_code == 200:
            """Successful Response"""
            if response.headers.get("Content-Type", None) == "application/json":
                return response.json()
    ...
    def form_test(self, body: BodyForm, ):
        ...
        cookies = {}
        body = body.to_dict()
        response = self.client.request('post', self.service_prefix, path, query, headers, cookies, form=body )
        if response.status_code == 200:
            """Successful Response"""
            if response.headers.get("Content-Type", None) == "application/json":
                return response.json()
    ...
    def file_test(self, body: BodyFile, ):
        ...
        cookies = {}
        body = body.to_dict()
        response = self.client.request('put', self.service_prefix, path, query, headers, cookies,)
        if response.status_code == 200:
            """Successful Response"""
            if response.headers.get("Content-Type", None) == "application/json":
                return response.json()
