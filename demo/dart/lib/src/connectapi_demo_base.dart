...
class Demo{
    ...
    Future<dynamic> queryTest(int a, String b, bool c, None d, {}) {
    ...
    Future<dynamic> queryOptionalTest({int a,String b,bool c,None d,}) {
    ...
    Future<dynamic> bodyOptionalTest({None body}) {
    ...
    Future<dynamic> pathTest(String a, int b, None c, {}) {
